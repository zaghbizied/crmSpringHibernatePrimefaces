...
public class Templates {
	...
	static {
		...
		dynamicReportsComponent =
		  cmp.horizontalList(
		  	cmp.image("/images/logo.gif"),
		  	cmp.verticalList(
		  		cmp.text("MyCompany").setStyle(bold22CenteredStyle).setHorizontalAlignment(HorizontalAlignment.LEFT),
		  		cmp.text("http://www.mycompany.org").setStyle(italicStyle).setHyperLink(link))).setFixedWidth(300);
